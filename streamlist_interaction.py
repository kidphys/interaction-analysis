...
interaction_count_data = interaction_count_data.groupby(['Presentationid', 'Presentation Name', 'Slideid', 'Slidetitle', 'Slideorder', 'Category']).size().reset_index().rename(columns={0: 'Interaction Count'})
